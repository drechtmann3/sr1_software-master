...
// firstbyte: In order to be kept happy in transmit mode, the I2C module must always be transmitting, or it will get
//            angry it has no more data to transmit ("Underflow"). So, give it the first byte (only applicable for transmits).
// Returns 1 if successful, 0 otherwise.
