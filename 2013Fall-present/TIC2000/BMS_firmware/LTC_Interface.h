...
#define MAX_MODULE_VOLTAGE_CAUTION 3.4f
#define MAX_MODULE_VOLTAGE_CRITICAL 3.7f
#define MIN_MODULE_VOLTAGE 2.5f
#define MIN_MODULE_VOLTAGE_CAUTION 3.0f
#define MIN_MODULE_VOLTAGE_CRITICAL 2.3f
