...
#if defined (TMR_V6)|| defined (TMR_V7) ||defined (TMR_V7_1) ||defined (TMR_V7_2) ||defined (TMR_V7_3) ||defined (TMR_V7_4)
...
#if defined (TMR_V7_4)
#define TIMER_GATE_SRC_Tx       0b11111101  //Timer(x+1) match PR(x+1)output
#define TIMER_GATE_SRC_CMP1     0b11111110  //Comparator1 output
#define TIMER_GATE_SRC_CMP2     0b11111111  //Comparator2 output
#else
...
#define TIMER_GATE_SRC_CMP1     0b00000010  //Comparator1 output
#define TIMER_GATE_SRC_CMP2     0b00000011  //Comparator2 output
#else 
